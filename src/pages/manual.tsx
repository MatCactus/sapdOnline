    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row w-full justify-around mt-10 break-words">
                <MenuBox title="Règlement" type="blank">
                    <a target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/16HdtDBXYlN8EBfQOaOvCbpDEivDvP9DDpVm8__0P-LU/edit">
            ...
            <div className="flex flex-col md:flex-row w-full justify-around mt-10 gap-y-4 md:gap-0">
                <MenuBox title="Codes d&#3État de Patrouille" type="blank">
